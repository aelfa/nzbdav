...
## [0.9.0](https://github.com/aelfa/nzbdav/compare/v0.8.1...v0.9.0) (2026-07-24)
...
* **api:** add database backup endpoints ([ba8b32c](https://github.com/aelfa/nzbdav/commit/ba8b32c71b43ef88f74c51653c95e1ea17203eb2))
...
* **api:** retention pruning for on-disk nzb backups ([ecf064a](https://github.com/aelfa/nzbdav/commit/ecf064a409672acb173066c4ff5a8f23005135c4))
...
* **db:** add backup store with manifests and retention pruning ([bfc0a18](https://github.com/aelfa/nzbdav/commit/bfc0a18a94140c2b16417017cf373cf0adaf25e9))
* **db:** add database backup task and daily scheduler ([7daa01d](https://github.com/aelfa/nzbdav/commit/7daa01d70a4f30307f0d2faaf440748acff4c349))
* **db:** add sqlite .sql dump and import utilities ([61442b1](https://github.com/aelfa/nzbdav/commit/61442b1f3a031083c37d4ff820be29ecdf83bb94))
* **db:** integrated database backup and restore ([ef4da2e](https://github.com/aelfa/nzbdav/commit/ef4da2e8dbf0b5096cb5cca9455be6d4089051bb))
...
* **db:** stage guided restore and swap databases during maintenance ([9777b08](https://github.com/aelfa/nzbdav/commit/9777b086b24e8dc004ea6895b738724b02983f08))
* **docker:** restart loop for staged database restores ([71fc260](https://github.com/aelfa/nzbdav/commit/71fc26057470bc1f001b587a6923477d5ab6ca1b))
...
* **health:** auto-remove files after repeated streaming failures ([5f6c2a3](https://github.com/aelfa/nzbdav/commit/5f6c2a31c125f611d0507dc5029a3847496f0fb3))
* **health:** auto-remove files after repeated streaming failures ([23f9479](https://github.com/aelfa/nzbdav/commit/23f9479059cdf8f3b05c38080bbaac9145225705))
* **health:** deletion audit log for DavItem removals ([b5efa7d](https://github.com/aelfa/nzbdav/commit/b5efa7d0bbf15cf12268cd55c6645c44dcb81049))
...
* **health:** structured audit log for all dav item deletions ([470f99d](https://github.com/aelfa/nzbdav/commit/470f99defe8bfa84bf2b28123af4648999cdaadf))
* make ThreadPool limits configurable ([00f1a4a](https://github.com/aelfa/nzbdav/commit/00f1a4ac7a9eb5a0de091a5788dc1a97b4fc5d3f))
* make ThreadPool limits configurable via env vars ([b8e8a98](https://github.com/aelfa/nzbdav/commit/b8e8a98ccae09d59ec69fc7bcfbbf277cd9ddad9))
...
* **nntp:** configurable idle connection timeout ([efb6fca](https://github.com/aelfa/nzbdav/commit/efb6fcaddd1db40816f141e38d24809a2e2f25fa))
...
* **nntp:** idle timeout and range prefetch cap ([#59](https://github.com/aelfa/nzbdav/issues/59)) ([8155e54](https://github.com/aelfa/nzbdav/commit/8155e5402ee7a2663a330a835ba3a95974c9fe8e))
...
* **nntp:** windowed breaker tripping with half-open probe ([3be32a8](https://github.com/aelfa/nzbdav/commit/3be32a8db016295c8f6e591d4fb9cdfb8f75588a))
...
* **queue:** blocklist unpack decoy files by default ([c563a4e](https://github.com/aelfa/nzbdav/commit/c563a4e4150a3cdcc26a326cb72890358ed58db8))
* **queue:** prefer PAR2 UniFileN unicode filenames when present ([8d43c8f](https://github.com/aelfa/nzbdav/commit/8d43c8fd3f8d770494c585d7c92273afd75d0351))
* **queue:** prefer PAR2 UniFileN unicode filenames when present ([a475d1e](https://github.com/aelfa/nzbdav/commit/a475d1eccb58f355ed087116fc01209efcd94b17))
...
* **queue:** recreate-strm-files maintenance task ([6930113](https://github.com/aelfa/nzbdav/commit/69301134629ed459d562bb34aa8bec6ad4302d00))
* **queue:** recreate-strm-files maintenance task ([d0e1763](https://github.com/aelfa/nzbdav/commit/d0e176336765d86e1187fefec04b7b9e47ee3b5f))
* **queue:** setting to fail jobs when non-video files have missing articles ([a735293](https://github.com/aelfa/nzbdav/commit/a73529317172bf073465e5621b26963d0aad96fe))
* **queue:** setting to fail jobs when non-video files have missing articles ([ddceddb](https://github.com/aelfa/nzbdav/commit/ddceddb921099915e485c5e58b5ade5794c5236a))
* **queue:** try duplicate nzb segment message-ids as ordered fallbacks ([dc264b7](https://github.com/aelfa/nzbdav/commit/dc264b786dbc711b5d2b6382528ab2fe49804dd5))
* **queue:** try duplicate nzb segment message-ids as ordered fallbacks ([a55d85c](https://github.com/aelfa/nzbdav/commit/a55d85c5130498e8c5a75fe6af0d8ed7faabb813))
...
* **ui:** add 1h Overview activity window ([a5aefe7](https://github.com/aelfa/nzbdav/commit/a5aefe777bfdff8969623ab2a4bd431e49e1216b))
...
* **ui:** add backup and restore settings tab ([06d218e](https://github.com/aelfa/nzbdav/commit/06d218ef33628e8a697d104c14744a05200d0ab1))
...
* **ui:** notify non-release builds of new commits on main ([85b5f22](https://github.com/aelfa/nzbdav/commit/85b5f22e7a3b7cf5731cf4b2c750f5856ae48d05))
* **ui:** notify stale source and dev builds ([00daa25](https://github.com/aelfa/nzbdav/commit/00daa25353b1331dd48e80bceb1ca4aa3a6565f2))
* **ui:** Overview 1h window and queue/nav polish ([976d090](https://github.com/aelfa/nzbdav/commit/976d09033a79646e635e42c6d7674d74ccde0ab0))
...
* **webdav:** maintenance task to rename windows-invalid dav paths ([7a01d8c](https://github.com/aelfa/nzbdav/commit/7a01d8c79c435ccf63ae5cf58305527a84354a0f))
* **webdav:** maintenance task to rename windows-invalid dav paths ([a7e839d](https://github.com/aelfa/nzbdav/commit/a7e839dd88fab4b6091f078df6a8ca9f444a23aa))
* **webdav:** per-segment streaming timeout with fast failover ([7ba0682](https://github.com/aelfa/nzbdav/commit/7ba0682e6094548f7fe4184044d0a312ce7d9376))
* **webdav:** per-segment streaming timeout with fast failover ([82d5b99](https://github.com/aelfa/nzbdav/commit/82d5b997848e6ca704d83e37b8140a7ebd3466e0))
...
* **websocket:** add bounded outbound backpressure ([5c8b6b5](https://github.com/aelfa/nzbdav/commit/5c8b6b56bac4424d6b2c13fdb566df2676232a08))
* **websocket:** add bounded outbound backpressure ([4758436](https://github.com/aelfa/nzbdav/commit/4758436cf9850d7e40dbda447a86a9c913018be0))
...
* **api:** correct whitespace formatting in NzbBackupRetentionService ([d418429](https://github.com/aelfa/nzbdav/commit/d418429fd1216e76bf3c2bf6766da46520c4cab5))
* **api:** skip unpack decoy videos in profiles play selection ([125c46c](https://github.com/aelfa/nzbdav/commit/125c46ca11e82b0cb13e26119ee1f8278b12c126))
* **api:** skip unpack decoy videos in profiles play selection ([ff7cf12](https://github.com/aelfa/nzbdav/commit/ff7cf12149830b5450a73c5d5fd2f709876709bc))
...
* **api:** validate forwarded headers and sanitize proxy ([ac84f98](https://github.com/aelfa/nzbdav/commit/ac84f9899b40f365073c41549e23e368c767cf2b))
...
* **auth:** harden frontend session key and cookie settings ([d1833b4](https://github.com/aelfa/nzbdav/commit/d1833b4c5cd410e7efe4f24834a30a1eb0f702f8)), closes [#219](https://github.com/aelfa/nzbdav/issues/219)
* **auth:** invalidate webdav sessions when credentials change ([051c47e](https://github.com/aelfa/nzbdav/commit/051c47e8c4fcffef9656adccf29e36240a98c085))
* **auth:** invalidate webdav sessions when credentials change ([3437fd6](https://github.com/aelfa/nzbdav/commit/3437fd6d066dce649987bfff32d6d502c30e7e10))
...
* **auth:** use fixed-time comparison for websocket API key auth ([19dce10](https://github.com/aelfa/nzbdav/commit/19dce10e6798fcba0b7bd23f3d15375599d054ec))
...
* **config:** clamp streaming-priority and harden numeric getters ([568d38f](https://github.com/aelfa/nzbdav/commit/568d38f06d87eb3ed3d27bf5a739d3c96a8a6e04))
...
* **config:** validate usenet providers to prevent MaxConnections boot-loop ([b7cc9cb](https://github.com/aelfa/nzbdav/commit/b7cc9cb8e47ba36eb431609db376dce1cb241d8d))
...
* **db:** delete DavItems batches by stored Id text to survive casing mismatch ([e89e920](https://github.com/aelfa/nzbdav/commit/e89e920775d5d04f12d0b516a5ce458ce2dc7e9e))
...
* **db:** don't read ConfigItems before migrations on fresh databases ([e89426a](https://github.com/aelfa/nzbdav/commit/e89426ac670571181988e66ca092a4e4e6e116f6))
* **db:** drain seeded empty dirs before asserting zero removals ([ffb36af](https://github.com/aelfa/nzbdav/commit/ffb36af5044ebd6f6a1a04608e17886c38c946b3))
* **db:** mark SegmentFallbackIds NotMapped for EF ([1920293](https://github.com/aelfa/nzbdav/commit/19202932b1127102742f2063c0dd79fb1e152381))
* **db:** NZB blob name cleanup and backup retention ([#83](https://github.com/aelfa/nzbdav/issues/83)) ([0c1c26e](https://github.com/aelfa/nzbdav/commit/0c1c26ef76ce39bcbdd2c923992304161d06727a))
...
* **db:** remove orphaned nzb name rows when blobs are cleaned up ([b2b281c](https://github.com/aelfa/nzbdav/commit/b2b281ca502350ed1a98ed588e7b36b838513f00))
...
* **deps:** bump react-router packages to 8.2.0 ([bff957d](https://github.com/aelfa/nzbdav/commit/bff957da77939f285e2a039b493d772f144e7cf1))
...
* **deps:** bump the github-actions group with 4 updates ([b60361f](https://github.com/aelfa/nzbdav/commit/b60361f0e49ccebbe3091cf9551eccd08a8ba841))
* **deps:** bump the github-actions group with 4 updates ([a79c6f4](https://github.com/aelfa/nzbdav/commit/a79c6f4c6097b1da023e698924cb4445575c0d91))
...
* fresh-database startup crash and Remove Orphaned Files stuck in Running ([5cad058](https://github.com/aelfa/nzbdav/commit/5cad058284ef15faecbc73d13cdfee156d27cd9a))
* **health:** align StreamingFailureTracker method names with callers ([77e3e67](https://github.com/aelfa/nzbdav/commit/77e3e67618814cd16765db651401b7804b11d143))
...
* **health:** complete streaming failure tracker wiring ([15e8f61](https://github.com/aelfa/nzbdav/commit/15e8f61935286396cb788c81879956a48ddc5468))
...
* **health:** hide deleted providers from overview stats ([a56c5ad](https://github.com/aelfa/nzbdav/commit/a56c5ad9fc6895d8a082fa5c47741d29d65e2c65))
* **health:** hide deleted providers from overview stats ([166a832](https://github.com/aelfa/nzbdav/commit/166a8327db20c136780f7b759274eadc15ee1073))
...
* **health:** remove duplicate dav-cleanup audit log block ([e8197ed](https://github.com/aelfa/nzbdav/commit/e8197edc88c266b85995b742d5cf49de76f39311))
...
* **metrics:** do not record STAT/HEAD/DATE successes as Missing ([7f7afcf](https://github.com/aelfa/nzbdav/commit/7f7afcf96ee43b9bb17356baad17767fc656b8d1))
* **nntp:** add connect/auth timeout and dispose failed handshakes ([2b0020b](https://github.com/aelfa/nzbdav/commit/2b0020bb70f9ff4cf9ad8b88b4d6d6da8227a610))
* **nntp:** add connect/auth timeout and dispose failed handshakes ([7f613b7](https://github.com/aelfa/nzbdav/commit/7f613b706f69f40046a4d9241793df48b09a02a1))
...
* **nntp:** count exhausted streaming timeouts toward the breaker ([c139846](https://github.com/aelfa/nzbdav/commit/c13984690a243bbea8c0587f42fb58cb6123a132))
* **nntp:** count exhausted streaming timeouts toward the breaker ([667dd5a](https://github.com/aelfa/nzbdav/commit/667dd5a0e2f40fc7ba0f8a199e851deb63899d1a))
* **nntp:** drain replaced clients before disposal ([39dcaa3](https://github.com/aelfa/nzbdav/commit/39dcaa31f01a88f6a534173b88151bcec6816a67))
* **nntp:** drain test hook inline without background loop ([772d77d](https://github.com/aelfa/nzbdav/commit/772d77db03ac47d588dca860e89bbbc5cf244412))
...
* **nntp:** gate individual stat/head requests through prioritized semaphore ([394a1d5](https://github.com/aelfa/nzbdav/commit/394a1d59b563153eec80cfe5c72a274d8319897a))
* **nntp:** gate individual STAT/HEAD through prioritized semaphore ([fd5e04a](https://github.com/aelfa/nzbdav/commit/fd5e04aa86cfbeb033b3e2517c20ee6be031ddba))
...
* **nntp:** log known transport failures without stack dumps ([ba80566](https://github.com/aelfa/nzbdav/commit/ba805662d2308a5f5c8779cda1f373c71f3df3b5))
* **nntp:** log known transport failures without stack dumps ([47930e2](https://github.com/aelfa/nzbdav/commit/47930e2d705980afbad2f350deff996498b8b816))
...
* **nntp:** route pipelined queue fetches through per-segment failover ([884b0d0](https://github.com/aelfa/nzbdav/commit/884b0d06b6f98d436de648405c3ffa52e65c7c59))
* **nntp:** route pipelined queue fetches through per-segment failover ([0b3a566](https://github.com/aelfa/nzbdav/commit/0b3a5660fb1b04f9d79a8c7c5a3812f0dfb2c808))
...
* **nntp:** stop invalid segment-id loops with 404 + repair ([0c89f9c](https://github.com/aelfa/nzbdav/commit/0c89f9cf55689cd869100c998b10dd3c02075c47))
* **nntp:** stop invalid segment-id loops with 404 + repair ([4d6d5f2](https://github.com/aelfa/nzbdav/commit/4d6d5f240c112c405104ccbe9ea7b1b76990dde2))
...
* **nntp:** wake queued waiters when PrioritizedSemaphore max increases ([cc28a0f](https://github.com/aelfa/nzbdav/commit/cc28a0f0175d4c77db063f65744dd32eba39d244))
...
* **queue:** accept split-rar sets with colliding header volume numbers ([705d7c2](https://github.com/aelfa/nzbdav/commit/705d7c29e43002feeaae07cf62520c71ddecaf22))
* **queue:** accept split-RAR sets with colliding header volume numbers ([35666aa](https://github.com/aelfa/nzbdav/commit/35666aa5570d671fd4084ad0335a218ae0d191dc))
...
* **queue:** back off on persistent loop errors and honor shutdown idle ([fa3721b](https://github.com/aelfa/nzbdav/commit/fa3721b31fdedfda55ca81f73d29f355fbc5cc6b))
...
* **queue:** cap ArticleCachingNntpClient cache-dir delete retries ([4f92d50](https://github.com/aelfa/nzbdav/commit/4f92d50da3a9d8e9c3f3b2d0b79d34631699d034))
* **queue:** create strm files for all video items of a job ([7ac0492](https://github.com/aelfa/nzbdav/commit/7ac04925f44ff026c263abd169c3d05e4fd91428))
* **queue:** create STRM files for all video items of a job ([2a0c60f](https://github.com/aelfa/nzbdav/commit/2a0c60f5374d52406b3606d63a4a2588aaabfb52))
* **queue:** decode utf-8 par2 filenames correctly for cjk releases ([53c502f](https://github.com/aelfa/nzbdav/commit/53c502fccb185c87abe98163cb40e84a9588c138))
* **queue:** decode UTF-8 PAR2 filenames for CJK releases ([9ad9fbe](https://github.com/aelfa/nzbdav/commit/9ad9fbe141f252ebbbb53de14dfb6bfde70d71fb))
* **queue:** dedupe and order NZB segments by number at parse time ([ff90c9d](https://github.com/aelfa/nzbdav/commit/ff90c9d8a99460bfb8f42a1644a9089b535f2261))
* **queue:** dedupe and order nzb segments by segment number at parse time ([b9b960b](https://github.com/aelfa/nzbdav/commit/b9b960b60b0169370524a0668979936061af58b1))
...
* **queue:** resolve metrics keys to hosts in live provider websocket ([4f27658](https://github.com/aelfa/nzbdav/commit/4f27658e6bd9c0f8593395711e72d254b0880993))
...
* RemoveUnlinkedFilesTask CI failures (Guid casing + dash pipefail) ([db3abd8](https://github.com/aelfa/nzbdav/commit/db3abd810ad1e3f5dabce8678aeb16ecce0c42a6))
...
* **sab:** avoid per-slot provider snapshots for queued items ([ca761ee](https://github.com/aelfa/nzbdav/commit/ca761eee92452bab0e2b56c6ce7fd62c64eda4eb))
* **sab:** avoid per-slot provider snapshots for queued items in mode=queue ([78b9276](https://github.com/aelfa/nzbdav/commit/78b9276cc64068032b2bff5b9039497dfd9b3dd0))
* **sab:** avoid per-slot provider snapshots for queued items in mode=queue ([1118465](https://github.com/aelfa/nzbdav/commit/111846537bc33d5d0888d2a00cae134e65ad8270))
* **sab:** cap unbounded history responses ([1b2abd9](https://github.com/aelfa/nzbdav/commit/1b2abd979ca68fe99effe8e3e7d87a118dea7512))
...
* SSR build ignoring custom server entry under Vite 8 ([81877c4](https://github.com/aelfa/nzbdav/commit/81877c4319de7bb7c442d6356cdd5e1a0f82210b))
...
* **ui:** add .js extension to proxy-path import for Node ESM ([83d5612](https://github.com/aelfa/nzbdav/commit/83d56122a4414be7a0d7d56f00e42f7cbdaafca9))
* **ui:** add frontend websocket hub heartbeat ([96766da](https://github.com/aelfa/nzbdav/commit/96766dad75986ae99c1ca57397f0e659248ce9cd)), closes [#225](https://github.com/aelfa/nzbdav/issues/225)
* **ui:** add security response headers for admin UI ([a42292a](https://github.com/aelfa/nzbdav/commit/a42292a7cbfa728ee59dde52ae8cf76adb602c1f)), closes [#215](https://github.com/aelfa/nzbdav/issues/215)
* **ui:** allow editing provider Already Used offset ([cce1b92](https://github.com/aelfa/nzbdav/commit/cce1b920252ba0ac3807c63b77ef867e0a4f780d)), closes [#256](https://github.com/aelfa/nzbdav/issues/256)
...
* **ui:** bound frontend websocket subscriptions and payload ([247c60d](https://github.com/aelfa/nzbdav/commit/247c60de6fa6e5f235c1d9ee6ed37e4a33fa06b2)), closes [#220](https://github.com/aelfa/nzbdav/issues/220)
* **ui:** check main source clones for new commits ([992489d](https://github.com/aelfa/nzbdav/commit/992489df12a97c27d253f8524bae900e853a82c6))
* **ui:** derive Remove Orphaned Files running state from user-initiated runs ([9aa543a](https://github.com/aelfa/nzbdav/commit/9aa543aa586a200c2c9fed6dd2c8147051f456af))
...
* **ui:** disable Link prefetch on explore directory links ([abc48f7](https://github.com/aelfa/nzbdav/commit/abc48f7e42838a9e031f0751d675e653cef9b794)), closes [#135](https://github.com/aelfa/nzbdav/issues/135)
* **ui:** disable X-Powered-By on SSR sub-app ([b8fdc9a](https://github.com/aelfa/nzbdav/commit/b8fdc9ad5bf69fbcb1d8ad3553d95723a8511d5b)), closes [#221](https://github.com/aelfa/nzbdav/issues/221)
...
* **ui:** frontend audit and UX batch ([9ecc16e](https://github.com/aelfa/nzbdav/commit/9ecc16e05d430c0af7ce2eecc6b78e4ba982acb4))
...
* **ui:** harden provider id generation and duplicate-host rendering ([2547e67](https://github.com/aelfa/nzbdav/commit/2547e672f4517eeba8a6c4c94115fb3d034974d5))
...
* **ui:** keep top-nav version label on one line ([ca268e1](https://github.com/aelfa/nzbdav/commit/ca268e175c529ed69d8cc6c95635b4acc893743d))
...
* **ui:** match proxy allowlist on path segment boundaries ([35ea307](https://github.com/aelfa/nzbdav/commit/35ea307177040632e3b6fa2372cb4d4309ad3859))
* **ui:** omit NZB file accept filter on iOS ([09970d4](https://github.com/aelfa/nzbdav/commit/09970d4d5671c3145a0fc034836c3c7e6ce48494)), closes [#140](https://github.com/aelfa/nzbdav/issues/140)
...
* **ui:** quiet expected BackendUnavailableError noise during startup grace ([86da280](https://github.com/aelfa/nzbdav/commit/86da2804d9a95250f1857479d835aed61cd7822d))
* **ui:** quiet expected BackendUnavailableError noise during startup grace ([5865305](https://github.com/aelfa/nzbdav/commit/5865305854f7b8b3fb4aed22e74ea499200fc68d))
...
* **ui:** resolve frontend startup crash from extensionless proxy-path import ([6eaf10d](https://github.com/aelfa/nzbdav/commit/6eaf10d84d920c43a7c1ba347d99478e92ac6ed6))
...
* **ui:** revalidate root loader when crossing login layout boundary ([b85f6c8](https://github.com/aelfa/nzbdav/commit/b85f6c8263924f9f9bfdcb52c5308890c9cccf4a)), closes [#226](https://github.com/aelfa/nzbdav/issues/226)
* **ui:** safe-decode paths in proxy auth and compression ([7e1d588](https://github.com/aelfa/nzbdav/commit/7e1d5886fb487a2a3bb1c5ba6c2e40a56b26272f))
* **ui:** self-host Inter and drop Google Fonts CDN ([0ad667c](https://github.com/aelfa/nzbdav/commit/0ad667ce4bfab295693b84522dd9d04a770f84a0)), closes [#222](https://github.com/aelfa/nzbdav/issues/222)
* **ui:** share one multiplexed WebSocket per browser tab ([57bc4a8](https://github.com/aelfa/nzbdav/commit/57bc4a877819729a2956ef153eae5d35bc31f215)), closes [#224](https://github.com/aelfa/nzbdav/issues/224)
...
* **ui:** skip root config revalidation on routine mutations ([9b8c257](https://github.com/aelfa/nzbdav/commit/9b8c257996204cf80ab462af60ae9fb65769fb6f)), closes [#226](https://github.com/aelfa/nzbdav/issues/226)
* **ui:** stack queue provider usage one per line ([6b5d297](https://github.com/aelfa/nzbdav/commit/6b5d297ac5c0a4546a6dd93c183fbd28dd8c52eb))
* **ui:** stack queue provider usage one per line ([bc1d3ee](https://github.com/aelfa/nzbdav/commit/bc1d3eefc4e2f0a11d2166de1ccd11b876515cfd))
* **ui:** stop counting provider misses as Overview errors ([c79010d](https://github.com/aelfa/nzbdav/commit/c79010dda4310f7fe6cde60708f0b1eef62ab4b6))
* **ui:** stop counting provider misses as Overview errors ([3484d21](https://github.com/aelfa/nzbdav/commit/3484d210cd54b10ee19bf0bf8426911a72cea69c))
* **ui:** stop idle providers overflowing the queue Provider column ([48359cd](https://github.com/aelfa/nzbdav/commit/48359cd52aa542f94ca8405ff9f7a9af3ec76255))
...
* **ui:** strip iOS accept attribute after mount to avoid hydration mismatch ([5be48a5](https://github.com/aelfa/nzbdav/commit/5be48a5f9ff48937b8f1d138af6fbbf4d4a3814c)), closes [#140](https://github.com/aelfa/nzbdav/issues/140)
* **ui:** use discover=none instead of prefetch=none on explore links ([eb54c8a](https://github.com/aelfa/nzbdav/commit/eb54c8a475405abf51d6ae7c1458b102162d917c)), closes [#135](https://github.com/aelfa/nzbdav/issues/135)
...
* **usenet:** key provider usage metrics by ProviderId ([192a047](https://github.com/aelfa/nzbdav/commit/192a047c7a61133200062a5d336588e08dcf8731))
* **usenet:** key provider usage metrics by ProviderId ([f6f20b3](https://github.com/aelfa/nzbdav/commit/f6f20b37f4f0c3b00631b4ecaebd0bed89eaee2a))
...
* **webdav:** cap segment prefetch at http range end ([e67cb37](https://github.com/aelfa/nzbdav/commit/e67cb37d2da3fc3d9c5ba507af4d486fd1a8bafe))
...
* **webdav:** clamp infinite-depth PROPFIND to depth 1 ([9b9638f](https://github.com/aelfa/nzbdav/commit/9b9638f7f52e6632b435912a8127a01267fe2d7c))
* **webdav:** dequeue dav cleanup items with lowercase guid ids ([92f5ca6](https://github.com/aelfa/nzbdav/commit/92f5ca61fe0836b166de34916515cd31655a2c71))
* **webdav:** drop pipefail dependency from Linux library scan ([5ef3490](https://github.com/aelfa/nzbdav/commit/5ef3490bbb80f9037d9228581c6dec4a8f313d9a))
...
* **webdav:** fall back to slow seek when fast-seek body read fails ([e8a0202](https://github.com/aelfa/nzbdav/commit/e8a0202d68bee375f50fe757633bc771d311a446))
* **webdav:** fall back to slow seek when fast-seek body read fails ([3a2a910](https://github.com/aelfa/nzbdav/commit/3a2a910eb16d56f01c339acb34c843e2853ef5fa))
* **webdav:** guarantee RemoveUnlinkedFiles terminates and reject concurrent runs ([064e70b](https://github.com/aelfa/nzbdav/commit/064e70b1e016fd27d05928d82b3a77de46b7e269))
* **webdav:** handle lowercase GUIDs in DAV cleanup queue ([a2eea70](https://github.com/aelfa/nzbdav/commit/a2eea70427be42ab93176b8c232b2e60296d56ba))
* **webdav:** handle malformed and unsatisfiable /view ranges ([ea83312](https://github.com/aelfa/nzbdav/commit/ea83312722d6210666163f1abf445ff230297775))
...
* **webdav:** sanitize dav path components for windows-invalid names ([27161ba](https://github.com/aelfa/nzbdav/commit/27161baa981846f3e2fb630101b2c0aaf5a933b3))
* **webdav:** sanitize Dav path components for Windows-invalid names ([1d2beaa](https://github.com/aelfa/nzbdav/commit/1d2beaae1d51e67b25136c4a99df16ad76ed8a09))
...
* **webdav:** stream and order directory listings from SQL ([425b9cc](https://github.com/aelfa/nzbdav/commit/425b9ccfe4764ba6512d4468c7e3b54b73597cd3)), closes [#238](https://github.com/aelfa/nzbdav/issues/238)
* **webdav:** stream and order large directory listings ([478a243](https://github.com/aelfa/nzbdav/commit/478a2435d76afdd94adfdaf98fa3711da7261991))
...
* **docs:** complete rclone sidecar setup guide gap-fill ([9aa666f](https://github.com/aelfa/nzbdav/commit/9aa666f1b391eff6b4fca121abbcbedc1e3f8d28))
* **docs:** complete rclone sidecar setup guide gap-fill ([8fb0eb8](https://github.com/aelfa/nzbdav/commit/8fb0eb8145c481f478d3228861609d5165e7450d))
...
* document integrated database backup and restore ([9c7fb51](https://github.com/aelfa/nzbdav/commit/9c7fb51a6819e6db739a8d9ac9d80e898f8191ec))
...
* document manual and blocklist dav-delete sources ([9a45914](https://github.com/aelfa/nzbdav/commit/9a45914e9bbf92cdd60d170b26ab6667dd570e75))
* explain content deletion sources and /config persistence ([e97dbcb](https://github.com/aelfa/nzbdav/commit/e97dbcb909d8772ae24b02a3aa9aaa4586223098))
